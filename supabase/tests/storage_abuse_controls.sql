...
DO $$
DECLARE
  upload_path constant text :=
    'e0000000-0000-4000-8000-000000000001/e1000000-0000-4000-8000-000000000001/00000001-0000-4000-8000-000000000001.pdf';
BEGIN
  IF NOT public.has_course_material_upload_reservation(
    upload_path,
    'e0000000-0000-4000-8000-000000000001',
    '{"contentLength":1026}'
  ) THEN
    RAISE EXCEPTION 'Managed Storage preflight metadata was rejected';
  END IF;
  IF public.has_course_material_upload_reservation(
    upload_path,
    'e0000000-0000-4000-8000-000000000001',
    '{"contentLength":1}'
  ) OR public.has_course_material_upload_reservation(
    upload_path,
    'e0000000-0000-4000-8000-000000000001',
    '{"contentLength":65539}'
  ) OR public.has_course_material_upload_reservation(
    upload_path,
    'e0000000-0000-4000-8000-000000000001',
    '{"size":3,"contentLength":1026}'
  ) THEN
    RAISE EXCEPTION 'Invalid Storage preflight length bypassed byte binding';
  END IF;
END;
$$;
