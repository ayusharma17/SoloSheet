...
-- BEGIN SOURCE: supabase/migration_phase17_open_signup_trial_flag.sql
...
GRANT EXECUTE ON FUNCTION public.get_non_edu_trial_credits_enabled(uuid, text, uuid),
  public.set_non_edu_trial_credits_enabled(boolean, uuid, text, uuid)
  TO service_role;
-- END SOURCE: supabase/migration_phase17_open_signup_trial_flag.sql

-- BEGIN SOURCE: supabase/migration_phase18_profile_recovery.sql
...
GRANT EXECUTE ON FUNCTION public.get_extraction_status(uuid)
  TO authenticated;
-- END SOURCE: supabase/migration_phase19_durable_extraction_jobs.sql
