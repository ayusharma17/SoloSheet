...
Apply `supabase/migration_phase6_credit_security.sql`, then `supabase/migration_phase7_atomic_extraction.sql`
before deploying the extraction API. Inspect deployed schema and grants first;
SQL checked into this repository does not establish deployment status.
