...
- `Test_Files/synthetic/`: self-authored upload fixture generated by
  `npm run fixtures:generate`; do not add third-party lecture material.
...
Use mocks or synthetic fixtures for routine verification. Any live Gemini or
hosted-database check must be an explicitly authorized, opt-in integration test.
